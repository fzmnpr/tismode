function VoteHeart() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path
        d="M17.1999 22C19.8509 22 21.9999 19.851 21.9999 17.2C21.9999 14.549 19.8509 12.4 17.1999 12.4C14.5489 12.4 12.3999 14.549 12.3999 17.2C12.3999 19.851 14.5489 22 17.1999 22Z"
        stroke="#EB5757"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
